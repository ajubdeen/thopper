...
class Score:
    ...
    def get_breakdown_display(self) -> str:
        ...
        lines.append("Ã¢â€¢Â" * 40)
        lines.append("")
        lines.append(f"  Survival ({self.turns_survived} turns Ãƒâ€” 10)".ljust(32) + f"{self.survival_points:>6}")
        lines.append(f"  Exploration ({self.eras_visited} eras Ãƒâ€” 50)".ljust(32) + f"{self.exploration_points:>6}")
        lines.append("")
    ...
    def get_narrative_summary(self) -> str:
        ...
        if self.ending_type == "abandoned":
            fulfillment_text = "The search continues elsewhereÃ¢â‚¬â€or perhaps it doesn't."
        ...
        # Ending narrative
        ending_texts = {
            "complete": "Your journey ended in completenessÃ¢â‚¬â€a full life, fully lived.",
...
class GameHistory:
    ...
    def get_game_summary(self, game: dict) -> str:
        ...
        lines = []
        lines.append(f"Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â {game['player_name']}'s Journey Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â")
        ...
        for era in game.get('eras', []):
            ...
            lines.append(f"  Ã¢â‚¬Â¢ {era.get('era_name', 'Unknown')} ({year_str})")
        ...
        for game in self.games:
            if game.get('id') == game_id:
                ...
                for era in game.get('eras', []):
                    ...
                    lines.append(f"Ã¢â€ÂÃ¢â€ÂÃ¢â€Â {era.get('era_name', 'Unknown')} ({year_str}) Ã¢â€ÂÃ¢â€ÂÃ¢â€Â")
                    lines.append("")
