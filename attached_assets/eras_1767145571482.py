...
no horses with saddles, no glass.""",
        ...
        "hard_rules": {
            "Lower": [
                "CorvÃƒÂ©e labor required - must work on Pharaoh's projects during flood season",
        ...
        "resources": [
            "Ã°Å¸“— 'The Egyptian' by Mika Waltari (historical fiction)",
            "Ã°Å¸“— 'Red Land, Black Land' by Barbara Mertz (accessible history)",
...
everywhere.""",
        ...
        "resources": [
            "Ã°Å¸“— 'The Histories' by Herodotus (ancient source, surprisingly readable)",
            "Ã°Å¸“— 'The Last Days of Socrates' by Plato",
...
No gunpowder weapons, no printing press (yet), distinctive Han dynasty aesthetics.""",
        ...
        "hard_rules": {
            "Lower": [
                ...
                "CorvÃƒÂ©e labor required for state projects (walls, canals)",
        ...
        "resources": [
            "Ã°Å¸“— 'The Silk Roads' by Peter Frankopan (accessible history)",
            "Ã°Å¸“— 'Chronicle of the Chinese Emperors' by Ann Paludan",
...
dominant yet, iron age technology.""",
        ...
        "figures": [
            ...
            "The VÃƒÂ¶lva - Seeress and spiritual leader, speaks with the gods",
        ...
        "real_people": [
            ...
            },
            {
                ...
                "description": "Two women buried in the richest Viking ship burial ever found. One may have been a vÃƒÂ¶lva (seeress). Their identities remain mysterious but show women could hold great status."
            }
        ],
        
        "resources": [
            "Ã°Å¸“— 'The Viking World' edited by Stefan Brink (comprehensive)",
            "Ã°Å¸“— 'Norse Mythology' by Neil Gaiman (accessible myths)",
...
No modern elements visible - no glass windows, no printed signs, no metal fixtures.""",
        ...
        "resources": [
            "Ã°Å¸“— 'The Decameron' by Giovanni Boccaccio (excerpts online)",
            "Ã°Å¸“— 'A Distant Mirror' by Barbara Tuchman (ages 12+)",
...
frame the valley. No horses, no iron, no wheat - distinctly Mesoamerican.""",
        ...
        "real_people": [
            ...
            },
            {
                ...
                "description": "An indigenous woman who became CortÃƒÂ©s' interpreter and advisor. Born noble, sold into slavery, she used her linguistic skills to survive. Mexicans still debate whether she was a traitor or a survivor."
            },
            {
        ...
        "resources": [
            "Ã°Å¸“— 'The Fifth Sun' by Camilla Townsend (modern history)",
            "Ã°Å¸“— 'Aztec' by Gary Jennings (epic historical fiction, mature)",
...
Minarets and Hindu temple spires both visible. Distinctive Mughal architecture.""",
        ...
        "resources": [
            "Ã°Å¸“— 'The Mughal World' by Abraham Eraly",
            "Ã°Å¸“— 'Akbar and the Rise of the Mughal Empire' by G.B. Malleson",
...
electricity or modern elements.""",
        ...
        "resources": [
            "Ã°Å¸“— 'Chains' by Laurie Halse Anderson (historical fiction, ages 10+)",
            "Ã°Å¸“— 'George vs. George' by Rosalyn Schanzer (accessible comparison)",
...
windows crowd together. No cars, no electricity lines, Victorian industrial aesthetic.""",
        ...
        "resources": [
            "Ã°Å¸“— 'Oliver Twist' by Charles Dickens",
            "Ã°Å¸“— 'Street Child' by Berlie Doherty (ages 9+)",
...
visible - this is the first photographed war. No modern military equipment.""",
        ...
        "resources": [
            "Ã°Å¸“— 'Lincoln: A Photobiography' by Russell Freedman (Newbery winner)",
            "Ã°Å¸“— 'Soldier's Heart' by Gary Paulsen",
...
A German soldier visible in the distance.""",
        ...
        "resources": [
            "Ã°Å¸“— 'The Diary of Anne Frank' - Anne Frank (essential reading)",
            "Ã°Å¸“— 'Number the Stars' by Lois Lowry (fiction, ages 9+)",
...
Rationing posters visible. Sense of wartime urgency and purpose.""",
        ...
        "resources": [
            "Ã°Å¸“— 'Farewell to Manzanar' by Jeanne Wakatsuki Houston (ages 11+)",
            "Ã°Å¸“— 'The War That Saved My Life' by Kimberly Brubaker Bradley",
...
aesthetic - no modern vehicles.""",
        ...
        "resources": [
            "Ã°Å¸“— 'The Night Diary' by Veera Hiranandani (ages 10+)",
            "Ã°Å¸“— 'Tamas' by Bhisham Sahni (for older readers)",
