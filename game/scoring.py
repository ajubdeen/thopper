...
class Score:
    ...
    def get_narrative_summary(self) -> str:
        ...
        if self.ending_type == "abandoned":
            fulfillment_text = "The search continues elsewhereÃ¢â‚¬"or perhaps it doesn't."
        ...
        # Ending narrative
        ending_texts = {
            "complete": "Your journey ended in completenessÃ¢â‚¬"a full life, fully lived.",
...
class GameHistory:
    ...
    def get_game_summary(self, game: dict) -> str:
        ...
        lines = []
        lines.append(f"Ã¢"¢ÂÃ¢"¢ÂÃ¢"¢Â {game['player_name']}'s Journey Ã¢"¢ÂÃ¢"¢ÂÃ¢"¢Â")
        ...
        for game in self.games:
            if game.get('id') == game_id:
                ...
                for era in game.get('eras', []):
                    ...
                    lines.append(f"Ã¢"ÂÃ¢"ÂÃ¢"Â {era.get('era_name', 'Unknown')} ({year_str}) Ã¢"ÂÃ¢"ÂÃ¢"Â")
                    lines.append("")
